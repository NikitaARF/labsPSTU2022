...
long Money::get_rub() { return rub; }

int Money::get_kop() { return kop; }

void Money::set_rub(long RUB) { rub = RUB; }

void Money::set_kop(int KOP) { kop = KOP; }
...
ostream& operator<<(ostream& out, const Money& A) { return (out << A.rub << "," << A.kop); }
